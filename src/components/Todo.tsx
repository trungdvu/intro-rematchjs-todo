...
const Todo: React.FC<TodoProps> = (props) => {
  ...
  return (
    <li className="cursor-pointer flex items-center group font-thin text-xl gap-2 text-left p-6 w-[34rem] bg-blue-primary active:bg-blue-primary-at transition-all duration-150 hover:bg-blue-primary-hv border-blue-secondary border-b">
      <button
